...
function stringToDateArray(_date, _format, _delimiter) {
...
function stringToTimeArray(_time, _format, _delimiter) {
    var formatLowerCase = _format.toLowerCase();
    var formatItems = formatLowerCase.split(_delimiter);
...
function endDateBeforeStartDate(startKey, endKey) {
    return function (group) {
        var start = group.controls[startKey];
        var end = group.controls[endKey];
...
exports.endDateBeforeStartDate = endDateBeforeStartDate;
