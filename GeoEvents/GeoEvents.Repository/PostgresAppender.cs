        ...
        protected override void Append(LoggingEvent loggingEvent)
        {
            using (NpgsqlConnection conn = new NpgsqlConnection("Server=192.168.21.10;Port=5432;Database=locoDB;User Id=postgres;Password=postgres;"))
            {
                ...
                using (NpgsqlCommand command = new NpgsqlCommand(AppenderQueryHelper.GetInsertLoggerQueryString(), conn))
                {
                    ...
                    appName.ParameterName = QueryConstants.ParAppName;
                    ...
                    thread.ParameterName = QueryConstants.ParThread;
                    ...
                    level.ParameterName = QueryConstants.ParLevel;
                    ...
                    location.ParameterName = QueryConstants.ParLocation;
                    ...
                    message.ParameterName = QueryConstants.ParMessage;
                    ...
                    log_date.ParameterName = QueryConstants.ParLogDate;
                    ...
                    exception.ParameterName = QueryConstants.ParException;
